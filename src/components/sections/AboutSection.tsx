...
export function AboutSection() {
  ...
  return (
    <section>
      ...
      {/* Services Section */}
      <div className="mb-12">
        <SectionTitle as="h3" color="yellow" className="text-xl mb-6">What I'm Doing</SectionTitle>
        <div className="grid md:grid-cols-2 gap-4">
          {services.map((service) => (
            <Card key={service.title} className="bg-zinc-800 border-zinc-700">
              <CardContent className="p-6 flex items-start gap-4">
                <div className="p-3 bg-yellow-500/10 rounded-md flex items-center justify-center">
                  {service.icon}
                </div>
                <div>
      ...
      {/* Skills Section */}
      <div>
        <SectionTitle as="h3" color="yellow" className="text-xl mb-6">Skills</SectionTitle>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {skills.map((skill) => (
            <Card key={skill.name} className="bg-zinc-800 border-zinc-700">
