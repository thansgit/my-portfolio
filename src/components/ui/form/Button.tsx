...
export function Button({
  ...
  return (
    <button
      ...
      className={`
        /* [Base Button] Core button styling */
        flex items-center justify-center rounded-md px-4 py-2 text-sm font-medium 
        transition-colors focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-1 
        disabled:opacity-70
        /* [Variant] Apply the selected variant style */
        ${variantStyles[variant]} 
        /* [Custom] Any custom classes passed */
        ${className}
      `}
    >
      {isLoading ? (
